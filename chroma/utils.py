...
def ringtest_with_output(gamma, n_ring, gen_target_image, gen_init_param, measure_ellip,
                         outfile, silent=False):
    ''' Performs a shear calibration ringtest, and outputs intermediate results to a FITS file.
