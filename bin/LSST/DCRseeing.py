...
def panel2plot():
    ...
    ax1.fill_between([1.5, 4.0], [1.5e-3, 1.5e-3], [1.e-5, 1.e-5],
                     color='grey', alpha=0.4, edgecolor='None')

    ax2.fill_between([0.0, 1.0], [1.5e-3, 1.5e-3], [1.e-5, 1.e-5],
                     color='grey', alpha=0.4, edgecolor='None')

    ax3.fill_between([0.1, 0.6], [1.5e-3, 1.5e-3], [1.e-5, 1.e-5],
                     color='grey', alpha=0.4, edgecolor='None')

    ax4.fill_between([0.0, 0.5], [1.5e-3, 1.5e-3], [1.e-5, 1.e-5],
                     color='grey', alpha=0.4, edgecolor='None')
