...
if __name__ == '__main__':
    ...
    parser.add_argument('--infile', default='star_data.pkl',
                        help="input file")
    parser.add_argument('--outfile', default='corrected_star_data.pkl',
                        help="output file")
    parser.add_argument('--ntrain', type=int, default=18000,
    ...
    stars = cPickle.load(open(args.infile))

    out = SVR_all(stars, ntrain=args.ntrain, ntest=args.ntest, use_color=args.use_color, use_colormag=args.use_colormag)
