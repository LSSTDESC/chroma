...
def R_vs_redshift(gals, stars, band, cband1, cband2, **kwargs):
    ...
    f.savefig('output/c_dR_z_stars.{}.png'.format(band), dpi=220)
...
def V_vs_redshift(gals, stars, band, cband1, cband2, **kwargs):
    ...
    f.savefig('output/c_dV_z_stars.{}.png'.format(band), dpi=220)
...
def S_vs_redshift(gals, stars, band, cband1, cband2, n=-0.2, **kwargs):
    ...
    f.savefig('output/c_dS_z_stars.{}.{}.png'.format(band, data_field), dpi=220)
