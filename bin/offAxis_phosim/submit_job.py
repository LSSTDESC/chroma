...
def submit_job(SED_type, filter_name, zenith, seed, redshift, test=False):
    ...
    sub_dir = '/nfs/slac/g/ki/ki19/jmeyers3/chroma/bin/offAxis_phosim/'
    ...
    if not os.path.exists('stdout/'):
        os.mkdir('stdout/')
    out_dir = '/nfs/slac/g/ki/ki19/jmeyers3/chroma/bin/offAxis_phosim/output/'
    command = '"cd {} && ./phosim {} -c {} -e0 sR20_S10 -o {}"'.format(phosim_dir,
                                                                       cat_file,
                                                                       extra_file,
                                                                       out_dir)
...
if __name__ == '__main__':
    ...
    for z in np.arange(0.0, 3.0, 0.03):
        submit_job('gal', 'r', 0, 1000, z)
        submit_job('gal', 'i', 0, 1000, z)
    submit_job('star', 'r', 0, 1000, 0.0)
    submit_job('star', 'i', 0, 1000, 0.0)
    submit_job('G5v', 'r', 0, 1000, 0.0)
    submit_job('G5v', 'i', 0, 1000, 0.0)
