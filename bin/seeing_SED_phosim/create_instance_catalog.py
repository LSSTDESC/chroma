...
def create_instance_catalog(SED_type, filter_name, zenith, seed, redshift, photon_goal=1e6):
    filter_number = {'u':'0','g':'1','r':'2','i':'3','z':'4','Y':'5'}
...
'''.format(int(round(90 - zenith)), filter_num, obshistid, seed)
    ...
    for iRA, RA in enumerate(RAs):
        ...
        mag_norm = mag_try - 2.5 * numpy.log10(photon_goal / photons)
...
if __name__ == '__main__':
    ...
    create_instance_catalog('G5v', 'r', 0, 1000, 0)
    create_instance_catalog('G5v', 'i', 0, 1000, 0)
    create_instance_catalog('star', 'r', 0, 1000, 0)
    create_instance_catalog('star', 'i', 0, 1000, 0)
    for z in zs:
        create_instance_catalog('gal', 'r', 0, 1000, z)
        create_instance_catalog('gal', 'i', 0, 1000, z)
