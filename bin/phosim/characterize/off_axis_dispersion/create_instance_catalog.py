...
def create_instance_catalog(SED_type, filter_name, zenith, seed, redshift):
    # pick the field_angle such that RA = DEC = 0 lies in the middle of
    # an outermost LSST chip (R20_S10)
    field_angle = 1.644700 # degrees
    filter_number = {'u':'0','g':'1','r':'2','i':'3','z':'4','Y':'5'}
...
SIM_VISTIME 15.0
SIM_NSNAP 1
'''.format(field_angle, int(round(90 - zenith)), filter_num, obshistid, seed)
    #load filter
    ...
    RAs = [-0.035, -0.025, -0.015, -0.005, 0.005, 0.015, 0.025, 0.035] # degrees
    DECs = [-0.035, -0.025, -0.015, -0.005, 0.005, 0.015, 0.025, 0.035] # degrees
