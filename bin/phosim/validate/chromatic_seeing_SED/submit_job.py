...
def submit_job(SED_type, filter_name, zenith, seed, redshift, test=False):
    ...
    sub_dir = '/nfs/slac/g/ki/ki19/jmeyers3/chroma/bin/seeing_SED_phosim/'
    ...
    if not os.path.exists('stdout/'):
        os.mkdir('stdout/')
    out_dir = '/nfs/slac/g/ki/ki19/jmeyers3/chroma/bin/seeing_SED_phosim/output/'
...
if __name__ == '__main__':
    ...
    for z in np.arange(0.0, 3.0, 0.03):
        submit_job('gal', 'r', 0.0, 1000, z)
        submit_job('gal', 'i', 0.0, 1000, z)
    submit_job('star', 'r', 0.0, 1000, 0.0)
    submit_job('star', 'i', 0.0, 1000, 0.0)
    submit_job('G5v', 'r', 0.0, 1000, 0.0)
    submit_job('G5v', 'i', 0.0, 1000, 0.0)
